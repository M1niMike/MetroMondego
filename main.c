...
int main()
{
   ...
   int i;
    ...
    do{
        ...
        switch(i){
            case 1:
                ppr = cmdRegistarParagem(ppr, &total);
                break;
            case 2:
                ppr = cmdEliminarParagem(ppr, &total);
                break;
            case 3:
                cmdListp(ppr, total);
                break;
            case 4:
                pln = cmdAdicionaLinha(pln, ppr, total);
                break;
            case 5:
                pln = cmdAtualizaLinha(pln, ppr, total);
                break;
            case 6:
                cmdListl(pln);
                break;
            case 7:
                cmdCalculaLinha(pln, ppr, total);
                break;
            case 8:
                pln = lerFicheiroLinha(pln,ppr, total);
                break;
        }
    }while(i != 9);
